...
export default function ArrowCard({ entry, pill }: Props) {
  return (
    <a
      ...
      class="group p-4 gap-3 flex flex-col border rounded-lg hover:bg-black/5 hover:dark:bg-white/10 border-black/15 dark:border-white/20 transition-colors duration-300 ease-in-out"
    >
      <img src={entry.data.banner} class="max-w-100" />
